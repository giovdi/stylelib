...
class BoxStat extends \DeployStudio\Style\Base\BoxStat {
	...
	static function stat ($variante, $bg, $icona, $titolo, $valore, $ext = null, $boxclass = 'col-12',
		$link = null, $testo_link = 'More info', $progress_percent = null, $progress_description = null) {
		switch ($variante) {
			case 1:
				$content = '
				<div class="info-box">
			...
			case 2:
				...
				<div class="info-box bg-'.$bg.'">
					<span class="info-box-icon push-bottom"><i class="'.$icona.'"></i></span>
					...
					<div class="info-box-content">
						...
						<div class="progress">
							<div class="progress-bar bg-white" style="width: '.$progress_percent.'%;"></div>
						</div>
						' : '')
						.'
			...
			case 3:
				...
				<div class="small-box bg-'.$bg.'">
					...
					<a href="'.$link.'" class="small-box-footer">
						'.$testo_link.' <i class="fa fa-arrow-right"></i>
					</a>' : '')
					.'
				</div>';
				break;
